...
/**
 * BuildingSyncService — registers the existing features/building/building.sync
 * syncBuildings() (SKKU campusMap.do crawl → raw/enriched/spaces upsert) with
 * the Nest PollerRegistry, mirroring index.ts's
 * `import "./features/building/building.sync"` side-effect + lib/pollers
 ...
 *
 * IMPORTANT — no double-run: importing features/building/building.sync ALSO
